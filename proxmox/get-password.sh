...
echo "  ArgoCD    : https://argocd.k8s.homelab.example"
echo "  Login     : admin / ${ARGOCD_PASS}"
echo ""

# Harbor
echo "  Harbor    : https://harbor.k8s.homelab.example"
...
echo "  GitLab    : https://gitlab.k8s.homelab.example"
...
echo "  Jenkins   : https://jenkins.k8s.homelab.example"
echo "  Login     : admin / ${JENKINS_PASS}"
echo ""

# SonarQube
echo "  SonarQube : https://sonarqube.k8s.homelab.example"
echo "  Login     : admin / admin (changement au 1er login)"
echo ""
echo ""

# Grafana
echo "  Grafana   : https://grafana.k8s.homelab.example"
echo "  Login     : admin / Ch4ng3M3!"
echo ""
echo "══════════════════════════════════════════"